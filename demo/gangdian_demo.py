...
from predictor_gd import COCODemo
...
def main():
    ...
    parser.add_argument(
        "--config-file",
        default="/home/e813/coding/gangdian/FCOS/k_config/fcos_R_101_FPN_2x.yaml",
        metavar="FILE",
        help="path to config file",
    )
    parser.add_argument(
        "--weights",
        default="/home/e813/coding/training_dir/fcos_imprv_R_50_FPN_1x/model_final.pth",
        metavar="FILE",
        help="path to the trained model",
    )
    parser.add_argument(
        "--images-dir",
        default="/media/e813/E/dataset/flag_k/demo2/",
        metavar="DIR",
    ...
    # ]
    thresholds_for_classes = [0.3 for _ in range(7)]
